...
function VacancyCard({
  ...
  const handleExportPDF = async () => {
    if (contentRef.current) {
      await exportToPdf(contentRef.current, "Вакансия.pdf");
    }
    onExportPDF?.();
  };
      ...
      <DialogContent className="max-w-none w-[90vw] sm:max-w-138 rounded-8">
        <div ref={contentRef} className="px-3 py-2">
          ...
          {(hasFranchise || hasDepartment) && (
            <div className="flex flex-col gap-2 body-overline text-gray-600 mt-2 mb-3">
          ...
          {hasDescription && (
            <div className="py-3 border-t border-b border-gray-200 -mx-3 px-3">
              <h3 className="mb-3 body-overline-semibold text-black">
                Описание вакансии
              </h3>
          ...
          {hasResponsibilities && (
            <div className="pt-3 pb-2 mt-3 bg-gray-50 rounded-8 -mx-3 px-3">
